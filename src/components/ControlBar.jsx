...
export function ControlBar() {
  ...
  return (
    <div className="flex flex-col relative w-full mt-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      {showTextInput && (
        <form onSubmit={handleTextSubmit} className="absolute bottom-18 left-0 right-0 p-2 bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20 z-50 shadow-2xl flex gap-2">
           <input 
             type="text" 
             value={textInput} 
      ...
      <div className="flex items-center justify-between w-full h-16 px-4 bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl relative overflow-hidden">
      ...
      <div className="group relative">
        <select 
          ...
          className="bg-transparent text-white/60 hover:text-white border-none outline-none text-xs font-bold px-2 py-1 rounded-lg cursor-pointer transition-colors appearance-none"
        >
