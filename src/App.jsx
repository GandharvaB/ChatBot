...
export default function App() {
  return (
    <div className="w-full h-screen bg-slate-900 overflow-hidden relative font-sans text-gray-800">
      
      {/* Background content representing a placeholder website */}
      <div className="absolute inset-0 p-12 overflow-auto">
        <h1 className="text-4xl text-white font-bold mb-6">Welcome to Your Platform</h1>
